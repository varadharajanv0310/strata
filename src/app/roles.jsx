                ...
                <span className="row gap6" style={{ alignItems: "center" }}>
                  {[["D", sc.demand], ["P", sc.pay], ["O", sc.opp]].map(([k, v]) => (
                    <span key={k} className="row gap6" style={{ alignItems: "center", marginRight: 4 }}>
                      ...
                      <span style={{ width: 28, height: 4, borderRadius: 9, background: "var(--wash-2)", overflow: "hidden", display: "inline-block" }}>
                        <span style={{ display: "block", width: `${v * 10}%`, height: "100%", background: "var(--bar)" }} />
                      </span>
                    </span>
                  ))}
                </span>
