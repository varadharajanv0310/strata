...
SO_YEARS = [2018, 2019, 2020, 2021, 2022, 2023, 2024]  # 2017 schema diverges; start at 2018
...
def fetch_and_aggregate() -> dict:
    ...
    for year in SO_YEARS:
        ...
        if not (sal_c and dev_c and "Country" in cols):
        ...
        for row in reader:
            ...
            if not rid:
                continue
            band = _exp_band(row.get(exp_c, "")) if exp_c else "pooled"
